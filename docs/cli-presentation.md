...
Typer/Rich command and help presentation is colorized by default. `--no-color` changes presentation only; it does not alter authorization models, evidence, invariants, validation plans, update verification, Web Command Console behavior, or API responses.
